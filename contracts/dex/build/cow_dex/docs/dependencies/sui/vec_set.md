...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_remove">remove</a>&lt;K: <b>copy</b> + drop&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">VecSet</a>&lt;K&gt;, key: &K) {
    <b>let</b> idx = self.contents.find_index!(|k| k == key).destroy_or!(<b>abort</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_EKeyDoesNotExist">EKeyDoesNotExist</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_length">length</a>&lt;K: <b>copy</b>, drop&gt;(self: &<a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">sui::vec_set::VecSet</a>&lt;K&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_length">length</a>&lt;K: <b>copy</b> + drop&gt;(self: &<a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">VecSet</a>&lt;K&gt;): u64 {
    self.contents.<a href="../../dependencies/sui/vec_set.md#sui_vec_set_length">length</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_is_empty">is_empty</a>&lt;K: <b>copy</b> + drop&gt;(self: &<a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">VecSet</a>&lt;K&gt;): bool {
    self.<a href="../../dependencies/sui/vec_set.md#sui_vec_set_length">length</a>() == 0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_set.md#sui_vec_set_from_keys">from_keys</a>&lt;K: <b>copy</b> + drop&gt;(<a href="../../dependencies/sui/vec_set.md#sui_vec_set_keys">keys</a>: vector&lt;K&gt;): <a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">VecSet</a>&lt;K&gt; {
    <b>let</b> <b>mut</b> set = <a href="../../dependencies/sui/vec_set.md#sui_vec_set_empty">empty</a>();
    <a href="../../dependencies/sui/vec_set.md#sui_vec_set_keys">keys</a>.do!(|key| set.<a href="../../dependencies/sui/vec_set.md#sui_vec_set_insert">insert</a>(key));
    set
}
</code></pre>
