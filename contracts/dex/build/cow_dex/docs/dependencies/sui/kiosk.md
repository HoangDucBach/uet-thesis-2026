...
- <code>listed</code> - A <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_place">place</a></code>d or a <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_lock">lock</a></code>ed item can be <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_list">list</a></code>ed for a fixed price
...
<dt>
<code>profits: <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;<a href="../../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;</code>
</dt>
<dd>
 Balance of the Kiosk - all profits from sales go here.
</dd>
<dt>
<code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>: <b>address</b></code>
</dt>
<dd>
 Always point to <code>sender</code> of the transaction.
 Can be changed by calling <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_set_owner">set_owner</a></code> with Cap.
</dd>
<dt>
<code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a>: u32</code>
</dt>
<dd>
...
<dd>
 ...
 <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_set_allow_extensions">set_allow_extensions</a></code> function - it is a legacy feature that is being
 replaced by the <code>kiosk_extension</code> module and its Extensions API.
 Exposes <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_uid_mut">uid_mut</a></code> publicly when set to <code><b>true</b></code>, set to <code><b>false</b></code> by default.
</dd>
</dl>
...
<dt>
<code>kiosk_id: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a></code>
</dt>
<dd>
 ID of the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a></code> the cap belongs to.
</dd>
<dt>
<code>item_id: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a></code>
</dt>
<dd>
...
<dl>
<dt>
<code>kiosk: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a></code>
</dt>
<dd>
</dd>
<dt>
...
Item does not match <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_Borrow">Borrow</a></code> in <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_return_val">return_val</a></code>.
...
<pre><code><b>entry</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_default">default</a>(ctx: &<b>mut</b> TxContext) {
    <b>let</b> (kiosk, cap) = <a href="../../dependencies/sui/kiosk.md#sui_kiosk_new">new</a>(ctx);
    <a href="../../dependencies/sui/transfer.md#sui_transfer_transfer">sui::transfer::transfer</a>(cap, ctx.sender());
    <a href="../../dependencies/sui/transfer.md#sui_transfer_share_object">sui::transfer::share_object</a>(kiosk);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_new">new</a>(ctx: &<b>mut</b> TxContext): (<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>) {
    <b>let</b> kiosk = <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a> {
        id: object::new(ctx),
        profits: balance::zero(),
        <a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>: ctx.sender(),
        <a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a>: 0,
        allow_extensions: <b>false</b>,
    };
    <b>let</b> cap = <a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a> {
        id: object::new(ctx),
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_close_and_withdraw">close_and_withdraw</a>(self: <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: <a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, ctx: &<b>mut</b> TxContext): Coin&lt;SUI&gt; {
    <b>let</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a> { id, profits, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>: _, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a>, allow_extensions: _ } = self;
    <b>let</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a> { id: cap_id, `<b>for</b>` } = cap;
    <b>assert</b>!(id.to_inner() == `<b>for</b>`, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> == 0, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotEmpty">ENotEmpty</a>);
    cap_id.delete();
    id.delete();
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_set_owner">set_owner</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, ctx: &TxContext) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a> = ctx.sender();
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_set_owner_custom">set_owner_custom</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>: <b>address</b>) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a> = <a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_place">place</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, item: T) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_place_internal">place_internal</a>(item)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_lock">lock</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>,
    _policy: &TransferPolicy&lt;T&gt;,
    item: T,
) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_lock_internal">lock_internal</a>(item)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_take">take</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID): T {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_locked">is_locked</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemLocked">EItemLocked</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed_exclusively">is_listed_exclusively</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EListedExclusively">EListedExclusively</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item">has_item</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> = self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> - 1;
    df::remove_if_exists&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a>, u64&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>false</b> });
    dof::remove(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_list">list</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID, price: u64) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item_with_type">has_item_with_type</a>&lt;T&gt;(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed_exclusively">is_listed_exclusively</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EListedExclusively">EListedExclusively</a>);
    df::add(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>false</b> }, price);
    event::emit(<a href="../../dependencies/sui/kiosk.md#sui_kiosk_ItemListed">ItemListed</a>&lt;T&gt; { kiosk: object::id(self), id, price })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_place_and_list">place_and_list</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>,
    item: T,
    price: u64,
    ...
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_place">place</a>(cap, item);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_list">list</a>&lt;T&gt;(cap, id, price)
}
</code></pre>
...
Remove an existing listing from the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a></code> and keep the item in the
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_delist">delist</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item_with_type">has_item_with_type</a>&lt;T&gt;(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed_exclusively">is_listed_exclusively</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EListedExclusively">EListedExclusively</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed">is_listed</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotListed">ENotListed</a>);
    df::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a>, u64&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>false</b> });
    event::emit(<a href="../../dependencies/sui/kiosk.md#sui_kiosk_ItemDelisted">ItemDelisted</a>&lt;T&gt; { kiosk: object::id(self), id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase">purchase</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    id: ID,
    payment: Coin&lt;SUI&gt;,
): (T, TransferRequest&lt;T&gt;) {
    <b>let</b> price = df::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a>, u64&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>false</b> });
    <b>let</b> inner = dof::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a>, T&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id });
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> = self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> - 1;
    <b>assert</b>!(price == payment.value(), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EIncorrectAmount">EIncorrectAmount</a>);
    df::remove_if_exists&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a>, bool&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a> { id });
    coin::put(&<b>mut</b> self.profits, payment);
    event::emit(<a href="../../dependencies/sui/kiosk.md#sui_kiosk_ItemPurchased">ItemPurchased</a>&lt;T&gt; { kiosk: object::id(self), id, price });
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_list_with_purchase_cap">list_with_purchase_cap</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>,
    id: ID,
    min_price: u64,
    ctx: &<b>mut</b> TxContext,
): <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt; {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item_with_type">has_item_with_type</a>&lt;T&gt;(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed">is_listed</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EAlreadyListed">EAlreadyListed</a>);
    df::add(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>true</b> }, min_price);
    <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt; {
        min_price,
        item_id: id,
        id: object::new(ctx),
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_with_cap">purchase_with_cap</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    purchase_cap: <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;,
    payment: Coin&lt;SUI&gt;,
): (T, TransferRequest&lt;T&gt;) {
    <b>let</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a> { id, item_id, kiosk_id, min_price } = purchase_cap;
    id.delete();
    <b>let</b> id = item_id;
    <b>let</b> paid = payment.value();
    <b>assert</b>!(paid &gt;= min_price, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EIncorrectAmount">EIncorrectAmount</a>);
    <b>assert</b>!(object::id(self) == kiosk_id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EWrongKiosk">EWrongKiosk</a>);
    df::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a>, u64&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>true</b> });
    coin::put(&<b>mut</b> self.profits, payment);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> = self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> - 1;
    df::remove_if_exists&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a>, bool&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a> { id });
    <b>let</b> item = dof::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a>, T&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id });
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_return_purchase_cap">return_purchase_cap</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, purchase_cap: <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;) {
    <b>let</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a> { id, item_id, kiosk_id, min_price: _ } = purchase_cap;
    <b>assert</b>!(object::id(self) == kiosk_id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EWrongKiosk">EWrongKiosk</a>);
    df::remove&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a>, u64&gt;(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id: item_id, is_exclusive: <b>true</b> });
    id.delete()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_withdraw">withdraw</a>(
    self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>,
    cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>,
    amount: Option&lt;u64&gt;,
    ctx: &<b>mut</b> TxContext,
    ...
    <b>let</b> amount = <b>if</b> (amount.is_some()) {
        ...
        <b>assert</b>!(amt &lt;= self.profits.value(), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotEnough">ENotEnough</a>);
        amt
    } <b>else</b> {
        self.profits.value()
    };
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_lock_internal">lock_internal</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, item: T) {
    df::add(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a> { id: object::id(&item) }, <b>true</b>);
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_place_internal">place_internal</a>(item)
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_place_internal">place_internal</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, item: T) {
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> = self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a> + 1;
    dof::add(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id: object::id(&item) }, item)
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_uid_mut_internal">uid_mut_internal</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): &<b>mut</b> UID {
    &<b>mut</b> self.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item">has_item</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, id: ID): bool {
    dof::exists_(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item_with_type">has_item_with_type</a>&lt;T: key + store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, id: ID): bool {
    dof::exists_with_type&lt;<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a>, T&gt;(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_locked">is_locked</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, id: ID): bool {
    df::exists_(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Lock">Lock</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed">is_listed</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, id: ID): bool {
    df::exists_(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>false</b> })
        || self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed_exclusively">is_listed_exclusively</a>(id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed_exclusively">is_listed_exclusively</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, id: ID): bool {
    df::exists_(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Listing">Listing</a> { id, is_exclusive: <b>true</b> })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_uid_mut_as_owner">uid_mut_as_owner</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>): &<b>mut</b> UID {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    &<b>mut</b> self.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_set_allow_extensions">set_allow_extensions</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, allow_extensions: bool) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_uid">uid</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): &UID {
    &self.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_uid_mut">uid_mut</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): &<b>mut</b> UID {
    <b>assert</b>!(self.allow_extensions, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EUidAccessNotAllowed">EUidAccessNotAllowed</a>);
    &<b>mut</b> self.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): <b>address</b> {
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_owner">owner</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): u32 {
    self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_item_count">item_count</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_profits_amount">profits_amount</a>(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>): u64 {
    self.profits.value()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_profits_mut">profits_mut</a>(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>): &<b>mut</b> Balance&lt;SUI&gt; {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_borrow">borrow</a>&lt;T: key + store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID): &T {
    <b>assert</b>!(object::id(self) == cap.`<b>for</b>`, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item">has_item</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    dof::borrow(&self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_borrow_mut">borrow_mut</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID): &<b>mut</b> T {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item">has_item</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed">is_listed</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemIsListed">EItemIsListed</a>);
    dof::borrow_mut(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_borrow_val">borrow_val</a>&lt;T: key, store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">sui::kiosk::Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">sui::kiosk::KioskOwnerCap</a>, id: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a>): (T, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Borrow">sui::kiosk::Borrow</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_borrow_val">borrow_val</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>, id: ID): (T, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Borrow">Borrow</a>) {
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_access">has_access</a>(cap), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_has_item">has_item</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemNotFound">EItemNotFound</a>);
    <b>assert</b>!(!self.<a href="../../dependencies/sui/kiosk.md#sui_kiosk_is_listed">is_listed</a>(id), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_EItemIsListed">EItemIsListed</a>);
    (dof::remove(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id }), <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Borrow">Borrow</a> { kiosk_id: object::id(self), item_id: id })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_return_val">return_val</a>&lt;T: key + store&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Kiosk">Kiosk</a>, item: T, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_borrow">borrow</a>: <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Borrow">Borrow</a>) {
    ...
    dof::add(&<b>mut</b> self.id, <a href="../../dependencies/sui/kiosk.md#sui_kiosk_Item">Item</a> { id: item_id }, item);
}
</code></pre>
...
Get the <code><b>for</b></code> field of the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a></code>.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_kiosk_owner_cap_for">kiosk_owner_cap_for</a>(cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">sui::kiosk::KioskOwnerCap</a>): <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_kiosk_owner_cap_for">kiosk_owner_cap_for</a>(cap: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_KioskOwnerCap">KioskOwnerCap</a>): ID {
    cap.`<b>for</b>`
}
</code></pre>
...
Get the <code>kiosk_id</code> from the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a></code>.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_kiosk">purchase_cap_kiosk</a>&lt;T: key, store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">sui::kiosk::PurchaseCap</a>&lt;T&gt;): <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_kiosk">purchase_cap_kiosk</a>&lt;T: key + store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;): ID {
    self.kiosk_id
}
</code></pre>
...
Get the <code>Item_id</code> from the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a></code>.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_item">purchase_cap_item</a>&lt;T: key, store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">sui::kiosk::PurchaseCap</a>&lt;T&gt;): <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_item">purchase_cap_item</a>&lt;T: key + store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;): ID {
    self.item_id
}
</code></pre>
...
Get the <code>min_price</code> from the <code><a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a></code>.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_min_price">purchase_cap_min_price</a>&lt;T: key, store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">sui::kiosk::PurchaseCap</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/kiosk.md#sui_kiosk_purchase_cap_min_price">purchase_cap_min_price</a>&lt;T: key + store&gt;(self: &<a href="../../dependencies/sui/kiosk.md#sui_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;): u64 {
    self.min_price
}
</code></pre>
