...
<dl>
<dt>
<code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a></code>
</dt>
<dd>
...
<dt>
<code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>: u64</code>
</dt>
<dd>
...
<dt>
<code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>: <a href="../../dependencies/sui/object.md#sui_object_ID">sui::object::ID</a></code>
</dt>
<dd>
...
<dd>
 ...
 were followed and <code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a></code> can be confirmed.
</dd>
</dl>
...
<dd>
 The Balance of the <code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a></code> which collects <code>SUI</code>.
...
<dt>
<code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>: <a href="../../dependencies/sui/vec_set.md#sui_vec_set_VecSet">sui::vec_set::VecSet</a>&lt;<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;</code>
</dt>
<dd>
 Set of types of attached rules - used to verify <code>receipts</code> when
 a <code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a></code> is received in <code><a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_confirm_request">confirm_request</a></code> function.
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_new_request">new_request</a>&lt;T&gt;(<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>: ID, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>: u64, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>: ID): <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt; {
    <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a> { <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>, receipts: vec_set::empty() }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_new">new</a>&lt;T&gt;(pub: &Publisher, ctx: &<b>mut</b> TxContext): (<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a>&lt;T&gt;) {
    <b>assert</b>!(package::from_package&lt;T&gt;(pub), 0);
    <b>let</b> id = object::new(ctx);
    <b>let</b> policy_id = id.to_inner();
    event::emit(<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCreated">TransferPolicyCreated</a>&lt;T&gt; { id: policy_id });
    (
        <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a> { id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>: vec_set::empty(), balance: balance::zero() },
        <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a> { id: object::new(ctx), policy_id },
    )
}
</code></pre>
...
<pre><code><b>entry</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_default">default</a>&lt;T&gt;(pub: &Publisher, ctx: &<b>mut</b> TxContext) {
    <b>let</b> (policy, cap) = <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_new">new</a>&lt;T&gt;(pub, ctx);
    <a href="../../dependencies/sui/transfer.md#sui_transfer_share_object">sui::transfer::share_object</a>(policy);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_withdraw">withdraw</a>&lt;T&gt;(
    self: &<b>mut</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
    cap: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a>&lt;T&gt;,
    amount: Option&lt;u64&gt;,
    ctx: &<b>mut</b> TxContext,
): Coin&lt;SUI&gt; {
    <b>assert</b>!(object::id(self) == cap.policy_id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ENotOwner">ENotOwner</a>);
    <b>let</b> amount = <b>if</b> (amount.is_some()) {
        <b>let</b> amt = amount.destroy_some();
        <b>assert</b>!(amt &lt;= self.balance.value(), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ENotEnough">ENotEnough</a>);
        amt
    } <b>else</b> {
        self.balance.value()
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_destroy_and_withdraw">destroy_and_withdraw</a>&lt;T&gt;(
    self: <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
    cap: <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a>&lt;T&gt;,
    ctx: &<b>mut</b> TxContext,
): Coin&lt;SUI&gt; {
    <b>assert</b>!(object::id(&self) == cap.policy_id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ENotOwner">ENotOwner</a>);
    <b>let</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a> { id: cap_id, policy_id } = cap;
    <b>let</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a> { id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>: _, balance } = self;
    id.delete();
    cap_id.delete();
    event::emit(<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyDestroyed">TransferPolicyDestroyed</a>&lt;T&gt; { id: policy_id });
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_confirm_request">confirm_request</a>&lt;T&gt;(
    self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
    request: <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt;,
): (ID, u64, ID) {
    <b>let</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a> { <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>, receipts } = request;
    <b>let</b> <b>mut</b> completed = receipts.into_keys();
    <b>let</b> <b>mut</b> total = completed.length();
    <b>assert</b>!(total == self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.length(), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_EPolicyNotSatisfied">EPolicyNotSatisfied</a>);
    <b>while</b> (total &gt; 0) {
        <b>let</b> rule_type = completed.pop_back();
        <b>assert</b>!(self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.contains(&rule_type), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_EIllegalRule">EIllegalRule</a>);
        total = total - 1;
    };
    (<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_add_rule">add_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    _: Rule,
    policy: &<b>mut</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
    cap: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a>&lt;T&gt;,
    cfg: Config,
) {
    <b>assert</b>!(object::id(policy) == cap.policy_id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ENotOwner">ENotOwner</a>);
    <b>assert</b>!(!<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_has_rule">has_rule</a>&lt;T, Rule&gt;(policy), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ERuleAlreadySet">ERuleAlreadySet</a>);
    df::add(&<b>mut</b> policy.id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_RuleKey">RuleKey</a>&lt;Rule&gt; {}, cfg);
    policy.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.insert(type_name::with_defining_ids&lt;Rule&gt;())
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_get_rule">get_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    _: Rule,
    policy: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
): &Config {
    df::borrow(&policy.id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_RuleKey">RuleKey</a>&lt;Rule&gt; {})
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_add_to_balance">add_to_balance</a>&lt;T, Rule: drop&gt;(_: Rule, policy: &<b>mut</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;, coin: Coin&lt;SUI&gt;) {
    <b>assert</b>!(<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_has_rule">has_rule</a>&lt;T, Rule&gt;(policy), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_EUnknownRequirement">EUnknownRequirement</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_add_receipt">add_receipt</a>&lt;T, Rule: drop&gt;(_: Rule, request: &<b>mut</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt;) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_has_rule">has_rule</a>&lt;T, Rule: drop&gt;(policy: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;): bool {
    df::exists_(&policy.id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_RuleKey">RuleKey</a>&lt;Rule&gt; {})
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_remove_rule">remove_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    policy: &<b>mut</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;,
    cap: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicyCap">TransferPolicyCap</a>&lt;T&gt;,
) {
    <b>assert</b>!(object::id(policy) == cap.policy_id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_ENotOwner">ENotOwner</a>);
    <b>let</b> _: Config = df::remove(&<b>mut</b> policy.id, <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_RuleKey">RuleKey</a>&lt;Rule&gt; {});
    policy.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.remove(&type_name::with_defining_ids&lt;Rule&gt;());
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_uid">uid</a>&lt;T&gt;(self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;): &UID { &self.id }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>&lt;T&gt;(self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferPolicy">TransferPolicy</a>&lt;T&gt;): &VecSet&lt;TypeName&gt; {
    &self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a>&lt;T&gt;(self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt;): ID { self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_item">item</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a>&lt;T&gt;(self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt;): u64 { self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_paid">paid</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a>&lt;T&gt;(self: &<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_TransferRequest">TransferRequest</a>&lt;T&gt;): ID { self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_from">from</a> }
</code></pre>
