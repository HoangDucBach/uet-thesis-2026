...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_increase_supply">increase_supply</a>&lt;T&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/balance.md#sui_balance_Supply">Supply</a>&lt;T&gt;, <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>: u64): <a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt; {
    <b>assert</b>!(<a href="../../dependencies/sui/balance.md#sui_balance_value">value</a> &lt;= (<a href="../../dependencies/std/u64.md#std_u64_max_value">std::u64::max_value</a>!() - self.<a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>), <a href="../../dependencies/sui/balance.md#sui_balance_EOverflow">EOverflow</a>);
...
Send a <code><a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a></code> to an address's funds accumulator.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_send_funds">send_funds</a>&lt;T&gt;(balance: <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;, recipient: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_send_funds">send_funds</a>&lt;T&gt;(balance: <a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;, recipient: <b>address</b>) {
    <a href="../../dependencies/sui/funds_accumulator.md#sui_funds_accumulator_add_impl">sui::funds_accumulator::add_impl</a>(balance, recipient);
}
</code></pre>
...
Redeem a <code>Withdrawal&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;</code> to get the underlying <code><a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;</code> from an address's funds
accumulator.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_redeem_funds">redeem_funds</a>&lt;T&gt;(withdrawal: <a href="../../dependencies/sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">sui::funds_accumulator::Withdrawal</a>&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;&gt;): <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_redeem_funds">redeem_funds</a>&lt;T&gt;(withdrawal: <a href="../../dependencies/sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">sui::funds_accumulator::Withdrawal</a>&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;): <a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt; {
...
Create a <code>Withdrawal&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;</code> from an object to withdraw funds from it.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_withdraw_funds_from_object">withdraw_funds_from_object</a>&lt;T&gt;(obj: &<b>mut</b> <a href="../../dependencies/sui/object.md#sui_object_UID">sui::object::UID</a>, <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>: u64): <a href="../../dependencies/sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">sui::funds_accumulator::Withdrawal</a>&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_withdraw_funds_from_object">withdraw_funds_from_object</a>&lt;T&gt;(obj: &<b>mut</b> UID, <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>: u64): Withdrawal&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt; {
    <a href="../../dependencies/sui/funds_accumulator.md#sui_funds_accumulator_withdraw_from_object">sui::funds_accumulator::withdraw_from_object</a>(obj, <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a> <b>as</b> u256)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_settled_funds_value">settled_funds_value</a>&lt;T&gt;(root: &<a href="../../dependencies/sui/accumulator.md#sui_accumulator_AccumulatorRoot">sui::accumulator::AccumulatorRoot</a>, <b>address</b>: <b>address</b>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_settled_funds_value">settled_funds_value</a>&lt;T&gt;(root: &<a href="../../dependencies/sui/accumulator.md#sui_accumulator_AccumulatorRoot">sui::accumulator::AccumulatorRoot</a>, <b>address</b>: <b>address</b>): u64 {
    <b>if</b> (!root.u128_exists&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(<b>address</b>)) {
        <b>return</b> 0
    };
    <b>let</b> val: u128 = root.u128_read&lt;<a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(<b>address</b>);
    <b>let</b> val = <a href="../../dependencies/std/u128.md#std_u128_min">std::u128::min</a>(<a href="../../dependencies/std/u64.md#std_u64_max_value">std::u64::max_value</a>!() <b>as</b> u128, val);
    val <b>as</b> u64
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_create_supply_internal">create_supply_internal</a>&lt;T&gt;(): <a href="../../dependencies/sui/balance.md#sui_balance_Supply">sui::balance::Supply</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_create_supply_internal">create_supply_internal</a>&lt;T&gt;(): <a href="../../dependencies/sui/balance.md#sui_balance_Supply">Supply</a>&lt;T&gt; {
    <a href="../../dependencies/sui/balance.md#sui_balance_Supply">Supply</a> { <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>: 0 }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../../dependencies/sui/balance.md#sui_balance_create_staking_rewards">create_staking_rewards</a>&lt;T&gt;(<a href="../../dependencies/sui/balance.md#sui_balance_value">value</a>: u64, ctx: &TxContext): <a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt; {
    ...
    <b>assert</b>!(
        <a href="../../dependencies/std/type_name.md#std_type_name_with_defining_ids">std::type_name::with_defining_ids</a>&lt;T&gt;().into_string().into_bytes() == <a href="../../dependencies/sui/balance.md#sui_balance_SUI_TYPE_NAME">SUI_TYPE_NAME</a>,
        <a href="../../dependencies/sui/balance.md#sui_balance_ENotSUI">ENotSUI</a>,
    );
    <a href="../../dependencies/sui/balance.md#sui_balance_Balance">Balance</a> { <a href="../../dependencies/sui/balance.md#sui_balance_value">value</a> }
}
</code></pre>
