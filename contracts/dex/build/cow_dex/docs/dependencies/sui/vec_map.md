...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_pop">pop</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(self.contents.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>() != 0, <a href="../../dependencies/sui/vec_map.md#sui_vec_map_EMapEmpty">EMapEmpty</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">sui::vec_map::VecMap</a>&lt;K, V&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): u64 {
    self.contents.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_is_empty">is_empty</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): bool {
    self.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>() == 0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_into_keys_values">into_keys_values</a>&lt;K: <b>copy</b>, V&gt;(self: <a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (vector&lt;K&gt;, vector&lt;V&gt;) {
    ...
    contents.do!(|<a href="../../dependencies/sui/vec_map.md#sui_vec_map_Entry">Entry</a> { key, value }| {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_from_keys_values">from_keys_values</a>&lt;K: <b>copy</b>, V&gt;(<a href="../../dependencies/sui/vec_map.md#sui_vec_map_keys">keys</a>: vector&lt;K&gt;, values: vector&lt;V&gt;): <a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    <b>assert</b>!(<a href="../../dependencies/sui/vec_map.md#sui_vec_map_keys">keys</a>.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>() == values.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>(), <a href="../../dependencies/sui/vec_map.md#sui_vec_map_EUnequalLengths">EUnequalLengths</a>);
    <b>let</b> <b>mut</b> contents = <a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a> { contents: vector[] };
    <a href="../../dependencies/sui/vec_map.md#sui_vec_map_keys">keys</a>.zip_do!(values, |key, value| contents.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_insert">insert</a>(key, value));
    contents
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_keys">keys</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): vector&lt;K&gt; {
    self.contents.map_ref!(|<a href="../../dependencies/sui/vec_map.md#sui_vec_map_Entry">Entry</a> { key, .. }| *key)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_get_idx_opt">get_idx_opt</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): Option&lt;u64&gt; {
    self.contents.find_index!(|<a href="../../dependencies/sui/vec_map.md#sui_vec_map_Entry">Entry</a> { key: k, .. }| k == key)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_get_idx">get_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): u64 {
    self.contents.find_index!(|<a href="../../dependencies/sui/vec_map.md#sui_vec_map_Entry">Entry</a> { key: k, .. }| k == key).destroy_or!(<b>abort</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_EKeyDoesNotExist">EKeyDoesNotExist</a>)
}
</code></pre>
...
Note that map entries are stored in insertion order, *not* sorted by key.
Aborts if <code>idx</code> is greater than or equal to <code>self.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>()</code>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/vec_map.md#sui_vec_map_get_entry_by_idx">get_entry_by_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../../dependencies/sui/vec_map.md#sui_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: u64): (&K, &V) {
    <b>assert</b>!(idx &lt; self.<a href="../../dependencies/sui/vec_map.md#sui_vec_map_length">length</a>(), <a href="../../dependencies/sui/vec_map.md#sui_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> <b>entry</b> = &self.contents[idx];
