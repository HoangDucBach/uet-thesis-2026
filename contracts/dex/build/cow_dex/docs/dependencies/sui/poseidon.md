...
<pre><code><b>const</b> <a href="../../dependencies/sui/poseidon.md#sui_poseidon_ETooManyInputs">ETooManyInputs</a>: u64 = 2;
</code></pre>
...
<pre><code><b>const</b> <a href="../../dependencies/sui/poseidon.md#sui_poseidon_MAX_INPUTS">MAX_INPUTS</a>: u64 = 16;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/poseidon.md#sui_poseidon_poseidon_bn254">poseidon_bn254</a>(data: &vector&lt;u256&gt;): u256 {
    <b>assert</b>!(data.length() &gt; 0, <a href="../../dependencies/sui/poseidon.md#sui_poseidon_EEmptyInput">EEmptyInput</a>);
    <b>assert</b>!(data.length() &lt;= <a href="../../dependencies/sui/poseidon.md#sui_poseidon_MAX_INPUTS">MAX_INPUTS</a>, <a href="../../dependencies/sui/poseidon.md#sui_poseidon_ETooManyInputs">ETooManyInputs</a>);
    <b>let</b> b = data.map_ref!(|e| {
        <b>assert</b>!(*e &lt; <a href="../../dependencies/sui/poseidon.md#sui_poseidon_BN254_MAX">BN254_MAX</a>, <a href="../../dependencies/sui/poseidon.md#sui_poseidon_ENonCanonicalInput">ENonCanonicalInput</a>);
        bcs::to_bytes(e)
    });
