...
<pre><code><b>const</b> <a href="../../dependencies/std/type_name.md#std_type_name_ASCII_LESS_THAN">ASCII_LESS_THAN</a>: u8 = 60;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_with_defining_ids">with_defining_ids</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_with_defining_ids">with_defining_ids</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_with_original_ids">with_original_ids</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_with_original_ids">with_original_ids</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>;
</code></pre>
...
Like <code><a href="../../dependencies/std/type_name.md#std_type_name_with_defining_ids">with_defining_ids</a></code>, this accesses the package ID that original defined the type <code>T</code>.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_defining_id">defining_id</a>&lt;T&gt;(): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_defining_id">defining_id</a>&lt;T&gt;(): <b>address</b>;
</code></pre>
...
Like <code><a href="../../dependencies/std/type_name.md#std_type_name_with_original_ids">with_original_ids</a></code>, this accesses the original ID of the package that defines type <code>T</code>,
even if the type was introduced in a later version of the package.


<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_original_id">original_id</a>&lt;T&gt;(): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_original_id">original_id</a>&lt;T&gt;(): <b>address</b>;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_as_string">as_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>): &<a href="../../dependencies/std/ascii.md#std_ascii_String">std::ascii::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_as_string">as_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): &String {
    &self.name
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_address_string">address_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>): <a href="../../dependencies/std/ascii.md#std_ascii_String">std::ascii::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_address_string">address_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): String {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_module_string">module_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>): <a href="../../dependencies/std/ascii.md#std_ascii_String">std::ascii::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_module_string">module_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): String {
    <b>assert</b>!(!self.<a href="../../dependencies/std/type_name.md#std_type_name_is_primitive">is_primitive</a>(), <a href="../../dependencies/std/type_name.md#std_type_name_ENonModuleType">ENonModuleType</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_datatype_string">datatype_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>): <a href="../../dependencies/std/ascii.md#std_ascii_String">std::ascii::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_datatype_string">datatype_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): String {
    <b>assert</b>!(!self.<a href="../../dependencies/std/type_name.md#std_type_name_is_primitive">is_primitive</a>(), <a href="../../dependencies/std/type_name.md#std_type_name_ENonModuleType">ENonModuleType</a>);
    // Starts after <b>address</b> and a double colon: `&lt;addr <b>as</b> HEX&gt;::`
    <b>let</b> <b>mut</b> i = address::length() * 2 + 2;
    <b>let</b> str_bytes = self.name.as_bytes();
    ...
    <b>let</b> <b>mut</b> datatype_name = vector[];
    <b>let</b> lt = <a href="../../dependencies/std/type_name.md#std_type_name_ASCII_LESS_THAN">ASCII_LESS_THAN</a>;
    <b>loop</b> {
        <b>let</b> char = &str_bytes[i];
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_get">get</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a> {
    <a href="../../dependencies/std/type_name.md#std_type_name_with_defining_ids">with_defining_ids</a>&lt;T&gt;()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_get_with_original_ids">get_with_original_ids</a>&lt;T&gt;(): <a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a> {
    <a href="../../dependencies/std/type_name.md#std_type_name_with_original_ids">with_original_ids</a>&lt;T&gt;()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_borrow_string">borrow_string</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): &String {
    self.<a href="../../dependencies/std/type_name.md#std_type_name_as_string">as_string</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_get_address">get_address</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): String {
    self.<a href="../../dependencies/std/type_name.md#std_type_name_address_string">address_string</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/type_name.md#std_type_name_get_module">get_module</a>(self: &<a href="../../dependencies/std/type_name.md#std_type_name_TypeName">TypeName</a>): String {
    self.<a href="../../dependencies/std/type_name.md#std_type_name_module_string">module_string</a>()
}
</code></pre>
