...
<a name="cow_dex_config_MAX_MIN_BOND"></a>



<pre><code><b>const</b> <a href="../cow_dex/config.md#cow_dex_config_MAX_MIN_BOND">MAX_MIN_BOND</a>: u64 = 1000000000000;
</code></pre>



<a name="cow_dex_config_MAX_COMMIT_DURATION_MS"></a>



<pre><code><b>const</b> <a href="../cow_dex/config.md#cow_dex_config_MAX_COMMIT_DURATION_MS">MAX_COMMIT_DURATION_MS</a>: u64 = 604800000;
</code></pre>



<a name="cow_dex_config_MAX_GRACE_PERIOD_MS"></a>



<pre><code><b>const</b> <a href="../cow_dex/config.md#cow_dex_config_MAX_GRACE_PERIOD_MS">MAX_GRACE_PERIOD_MS</a>: u64 = 604800000;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/config.md#cow_dex_config_set_min_bond">set_min_bond</a>(<a href="../cow_dex/config.md#cow_dex_config">config</a>: &<b>mut</b> <a href="../cow_dex/config.md#cow_dex_config_GlobalConfig">GlobalConfig</a>, new_min_bond: u64, _cap: &<a href="../cow_dex/config.md#cow_dex_config_AdminCap">AdminCap</a>) {
    ...
    <b>assert</b>!(new_min_bond &lt;= <a href="../cow_dex/config.md#cow_dex_config_MAX_MIN_BOND">MAX_MIN_BOND</a>, <a href="../cow_dex/config.md#cow_dex_config_EInvalidBondAmount">EInvalidBondAmount</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/config.md#cow_dex_config_set_commit_duration">set_commit_duration</a>(
    ...
    <b>assert</b>!(new_commit_duration_ms &lt;= <a href="../cow_dex/config.md#cow_dex_config_MAX_COMMIT_DURATION_MS">MAX_COMMIT_DURATION_MS</a>, <a href="../cow_dex/config.md#cow_dex_config_EInvalidDuration">EInvalidDuration</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/config.md#cow_dex_config_set_grace_period">set_grace_period</a>(<a href="../cow_dex/config.md#cow_dex_config">config</a>: &<b>mut</b> <a href="../cow_dex/config.md#cow_dex_config_GlobalConfig">GlobalConfig</a>, new_grace_period_ms: u64, _cap: &<a href="../cow_dex/config.md#cow_dex_config_AdminCap">AdminCap</a>) {
    ...
    <b>assert</b>!(new_grace_period_ms &lt;= <a href="../cow_dex/config.md#cow_dex_config_MAX_GRACE_PERIOD_MS">MAX_GRACE_PERIOD_MS</a>, <a href="../cow_dex/config.md#cow_dex_config_EInvalidDuration">EInvalidDuration</a>);
