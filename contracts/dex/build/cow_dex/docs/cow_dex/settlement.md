...
<a name="cow_dex_settlement_EOutputInsufficient"></a>



<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_EOutputInsufficient">EOutputInsufficient</a>: u64 = 2;
</code></pre>
...
<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_EClearingPriceMismatch">EClearingPriceMismatch</a>: u64 = 3;
</code></pre>
...
<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_ENotWinner">ENotWinner</a>: u64 = 4;
</code></pre>
...
<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_EScoreMismatch">EScoreMismatch</a>: u64 = 5;
</code></pre>
...
<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_EInvalidDeadline">EInvalidDeadline</a>: u64 = 6;
</code></pre>
...
<pre><code><b>const</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_EWrongBatch">EWrongBatch</a>: u64 = 7;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_close_commits">close_commits</a>(state: &<b>mut</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_AuctionState">AuctionState</a>, clock: &Clock) {
    ...
    emit(<a href="../cow_dex/settlement.md#cow_dex_settlement_WinnerSelectedEvent">WinnerSelectedEvent</a> {
        ...
        <a href="../cow_dex/settlement.md#cow_dex_settlement_winner">winner</a>: *<a href="../dependencies/std/option.md#std_option_borrow">std::option::borrow</a>(&state.<a href="../cow_dex/settlement.md#cow_dex_settlement_winner">winner</a>),
...
* <code>min_required</code>: Minimum output required by user (intent.min_amount_out).
* <code>ebbo_floor</code>: EBBO floor price (max(min_required, mid_price × sell × 99/100)).
* <code>ctx</code>: Transaction context.

Type Parameters:
* <code>SellCoin</code>: Coin type user was selling.
* <code>BuyCoin</code>: Coin type user is receiving.


<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_process_intent">process_intent</a>&lt;SellCoin, BuyCoin&gt;(ticket: &<b>mut</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_SettlementTicket">cow_dex::settlement::SettlementTicket</a>, intent: <a href="../cow_dex/intent_book.md#cow_dex_intent_book_Intent">cow_dex::intent_book::Intent</a>&lt;SellCoin, BuyCoin&gt;, payout: <a href="../dependencies/sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;BuyCoin&gt;, min_required: u64, ebbo_floor: u64, ctx: &<b>mut</b> <a href="../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../cow_dex/settlement.md#cow_dex_settlement_process_intent">process_intent</a>&lt;SellCoin, BuyCoin&gt;(
    ...
    <b>assert</b>!(<a href="../dependencies/std/option.md#std_option_is_some">std::option::is_some</a>(&intent_batch_id), <a href="../cow_dex/settlement.md#cow_dex_settlement_EWrongBatch">EWrongBatch</a>);
    <b>assert</b>!(*<a href="../dependencies/std/option.md#std_option_borrow">std::option::borrow</a>(&intent_batch_id) == ticket.<a href="../cow_dex/settlement.md#cow_dex_settlement_batch_id">batch_id</a>, <a href="../cow_dex/settlement.md#cow_dex_settlement_EWrongBatch">EWrongBatch</a>);
    // Check EBBO: actual payout &gt;= max(min_required, ebbo_floor)
    <b>let</b> actual = coin::value(&payout);
    <b>assert</b>!(actual &gt;= min_required, <a href="../cow_dex/settlement.md#cow_dex_settlement_EOutputInsufficient">EOutputInsufficient</a>);
    ...
    <b>let</b> (owner, sell_balance, _) = <a href="../cow_dex/intent_book.md#cow_dex_intent_book_consume_intent">cow_dex::intent_book::consume_intent</a>(intent);
    // Transfer payout to user
    transfer::public_transfer(payout, owner);
    // Return sell coins to caller (<a href="../cow_dex/settlement.md#cow_dex_settlement_winner">winner</a> solver)
